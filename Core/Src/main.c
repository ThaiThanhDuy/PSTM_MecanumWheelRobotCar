...
/* USER CODE BEGIN PV */
int16_t positionMotor1;
int16_t positionMotor2;
int16_t positionMotor3;
int16_t positionMotor4;
uint8_t rx_data;
...
void UART_ReceiveData(void) {
    ...
    HAL_UART_Receive(&huart2, (uint8_t*)receivedData, sizeof(receivedData) - 1, HAL_MAX_DELAY); // Receive data
